...
# These are the compiler and linker flags used by Python's distutils.core.setup()
...
gcc $CC_FLAGS mypydl.c -I/usr/include/python3.4m -lpython3.4m $LD_FLAGS -Xlinker -export-dynamic -o mypydl.so 
